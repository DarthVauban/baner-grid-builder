...
export function storefrontThemeStyle(theme: CatalogStorefrontTheme): ThemeStyle {
  return {
    ...
    '--sf-brand-weight': theme.header.brandWeight,
    '--sf-brand-logo-height': `${theme.header.logoHeight}px`,
    '--sf-header-action-display': theme.header.actionVisible ? 'inline-flex' : 'none',
    '--sf-header-text': theme.header.textColor,
    '--sf-header-muted': theme.header.mutedColor,
    '--sf-header-link': theme.header.linkColor,
    '--sf-header-tagline-size': `${theme.header.taglineSize}px`,
    '--sf-header-tagline-weight': theme.header.taglineWeight,
    '--sf-header-link-size': `${theme.header.linkSize}px`,
    '--sf-header-link-weight': theme.header.linkWeight,
    '--sf-mobile-menu-bg': theme.header.mobileMenu.background,
    '--sf-mobile-menu-text': theme.header.mobileMenu.textColor,
    '--sf-mobile-menu-divider': theme.header.mobileMenu.dividerColor,
    '--sf-mobile-menu-overlay': theme.header.mobileMenu.overlayColor,
    '--sf-mobile-menu-overlay-opacity': `${theme.header.mobileMenu.overlayOpacity}%`,
    '--sf-mobile-toggle-bg': theme.header.mobileMenu.toggleBackground,
    '--sf-mobile-toggle-color': theme.header.mobileMenu.toggleColor,
    '--sf-mobile-toggle-border': theme.header.mobileMenu.toggleBorderColor,
    '--sf-mobile-toggle-size': `${theme.header.mobileMenu.toggleSize}px`,
    '--sf-mobile-toggle-radius': `${theme.header.mobileMenu.toggleRadius}px`,
    '--sf-mobile-menu-link-size': `${theme.header.mobileMenu.linkSize}px`,
    '--sf-mobile-menu-link-weight': theme.header.mobileMenu.linkWeight,
    '--sf-mobile-menu-align': theme.header.mobileMenu.alignment,
    '--sf-mobile-menu-justify': theme.header.mobileMenu.alignment === 'center' ? 'center' : theme.header.mobileMenu.alignment === 'right' ? 'flex-end' : 'flex-start',
    '--sf-footer-display': theme.footer.visible ? 'block' : 'none',
    '--sf-footer-bg': theme.footer.background,
    '--sf-footer-text': theme.footer.textColor,
    '--sf-footer-muted': theme.footer.mutedColor,
    '--sf-footer-border': theme.footer.borderColor,
    '--sf-footer-border-width': `${theme.footer.borderWidth}px`,
    '--sf-footer-padding-top': `${theme.footer.paddingTop}px`,
    '--sf-footer-padding-bottom': `${theme.footer.paddingBottom}px`,
    '--sf-footer-logo-height': `${theme.footer.logoHeight}px`,
    '--sf-footer-brand-size': `${theme.footer.brandSize}px`,
    '--sf-footer-brand-weight': theme.footer.brandWeight,
    '--sf-footer-body-size': `${theme.footer.bodySize}px`,
    '--sf-footer-body-weight': theme.footer.bodyWeight,
    '--sf-footer-heading-size': `${theme.footer.headingSize}px`,
    '--sf-footer-heading-weight': theme.footer.headingWeight,
    '--sf-footer-link-size': `${theme.footer.linkSize}px`,
    '--sf-footer-link-weight': theme.footer.linkWeight,
    '--sf-footer-copyright-size': `${theme.footer.copyrightSize}px`,
    '--sf-footer-copyright-weight': theme.footer.copyrightWeight,
