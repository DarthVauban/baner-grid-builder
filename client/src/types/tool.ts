export type ToolId = 'banner_grid' | 'product_selection' | 'product_tables' | 'blog_publications' | 'chat' | 'applications' | 'form_builder' | 'used_smartphones_catalog' | 'trade_in' | 'store_map' | 'facebook_group_publications';
