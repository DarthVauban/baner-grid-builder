...
- desktop-поверхня закріплює панель у нижньому правому кутку, mobile-поверхня використовує
  адаптивну нижню панель; картки товарів прокручуються горизонтально всередині неї;
