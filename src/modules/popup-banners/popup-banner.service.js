...
export function popupEmbedScript(origin) {
  ...
  function render(payload, productArticle) {
    ...
    style.textContent += '.promo-code-offer{border-color:color-mix(in srgb,var(--promo-code-bg) 24%,transparent);background:color-mix(in srgb,var(--promo-code-bg) var(--promo-code-bg-opacity),transparent)}.promo-code-copy{border-color:var(--promo-copy-bg);color:var(--promo-copy-text);background:var(--promo-copy-bg)}';
