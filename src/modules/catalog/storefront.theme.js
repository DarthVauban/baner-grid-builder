...
export const defaultStorefrontTheme = {
  ...
  footer: {
    ...
    phone: '',
    address: '',
    copyright: 'Mobile Trend. Усі права захищені.',
    sections: [{ id: 'navigation', title: 'Навігація', links: [{ id: 'catalog', label: 'Каталог', url: '/', newTab: false }] }],
    socialLinks: []
  },
  hero: {
    visible: true,
