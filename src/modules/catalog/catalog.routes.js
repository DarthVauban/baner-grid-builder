...
const storefrontThemeSchema = z.object({
  ...
  header: z.object({
    ...
    taglineSize: z.coerce.number().int().min(8).max(24),
    taglineWeight: themeFontWeightSchema,
  ...
  footer: z.object({
    ...
    brandSize: z.coerce.number().int().min(10).max(34),
    brandWeight: themeFontWeightSchema,
    bodySize: z.coerce.number().int().min(9).max(24),
    bodyWeight: themeFontWeightSchema,
    headingSize: z.coerce.number().int().min(9).max(28),
    headingWeight: themeFontWeightSchema,
    linkSize: z.coerce.number().int().min(9).max(24),
    linkWeight: themeFontWeightSchema,
    copyrightSize: z.coerce.number().int().min(8).max(20),
    copyrightWeight: themeFontWeightSchema,
