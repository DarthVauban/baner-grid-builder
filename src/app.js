...
import promoCodeRoutes from './modules/promo-codes/promo-code.routes.js';
import productSelectionRoutes from './modules/product-selections/product-selection.routes.js';
import publicProductSelectionRoutes from './modules/product-selections/product-selection.public.routes.js';
...
app.use('/api/desktop/photo-parser', horoshopPhotoDesktopRoutes);
