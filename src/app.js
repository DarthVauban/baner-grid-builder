...
import publicProductPriceRoutes from './modules/product-price/product-price.public.routes.js';
...
if (env.APP_ORIGIN) {
  app.use((req, res, next) => {
    ...
    if (req.path.startsWith('/api/public/product-price')) return next();
...
app.use('/api/public/product-price', publicEmbedCors, publicProductPriceRoutes);
