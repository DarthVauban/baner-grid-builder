...
- інтеграція з Хорошоп: синхронізований каталог, супутні товари, Codex-рев’ю, парсер і публікація фото,
  CSS-only теми штатного меню та Telegram QR-блок після замовлення;
...
- `/tools/horoshop-checkout-telegram` — QR-код і Telegram-кнопка після оформлення замовлення;
...
Почніть з [індексу документації](docs/README.md), [архітектури](docs/architecture.md) і
[DOM-контракту desktop/mobile вітрини Хорошопа](docs/horoshop-storefront-dom-contract.md).
Search-документи чітко розділяють фактичний стан і затверджену цільову архітектуру.
